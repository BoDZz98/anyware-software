...
exports.deleteReview = exports.updateReview = exports.getMovieReviews = exports.getQuizzes = exports.createReview = void 0;
...
const updateReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { reviewId, newRating, newDesc, email } = (yield req.body);
    try {
        ...
        const userReviews = yield reviewsModel_1.default.find({ email });
        return res.status(201).json({ message: "Review updated", userReviews });
    }
    catch (error) {
